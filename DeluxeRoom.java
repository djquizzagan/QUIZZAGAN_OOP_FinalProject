...
public DeluxeRoom() {
super("Deluxe Room", 
        "This luxury Deluxe Room Type features three different room styles, each tailored to fit your ideal choice!", 
        "Php 3300-4500"); 
}
...
System.out.println("\t\t\t\t\t\t\t\t=============");
System.out.println("Deluxe Room A: Price: Php 3300\n- 1 King Bed\n- Free Wi-Fi\n- All Meals\n- Airconditioned\n- Karaoke/Balcony View");
System.out.println("Deluxe Room B: Price: Php 3700\n- 2 Queen Beds\n- Free Wi-Fi\n- All Meals\n- Airconditioned\n- Pool and Karaoke");
System.out.println("Deluxe Room C: Price: Php 4500\n- 2 King Beds\n- Free Wi-Fi\n- All Meals\n- Airconditioned with TV\n- Pool and Mini Bar");

Scanner input = new Scanner(System.in);
System.out.print("Enter your choice (A, B, C): ");
String deluxeChoice = input.nextLine().trim().toLowerCase();
System.out.print("==================================================================================================================================================================");
System.out.print("\n\n");

switch (deluxeChoice) {
    case "a":
        showRoomDetails("A", 3300, "- 1 King Bed\n\t\t\t\t\t\t\t\t- Free Wi-Fi\n\t\t\t\t\t\t\t\t- All Meals\n\t\t\t\t\t\t\t\t- Airconditioned\n\t\t\t\t\t\t\t\t- Karaoke/Balcony View");
        break;
    case "b":
        showRoomDetails("B", 3700, "- 2 Queen Beds\n\t\t\t\t\t\t\t\t- Free Wi-Fi\n\t\t\t\t\t\t\t\t- All Meals\n\t\t\t\t\t\t\t\t- Airconditioned\n\t\t\t\t\t\t\t\t- Pool and Karaoke");
        break;
    case "c":
        showRoomDetails("C", 4500, "- 2 King Beds\n\t\t\t\t\t\t\t\t- Free Wi-Fi\n\t\t\t\t\t\t\t\t- All Meals\n\t\t\t\t\t\t\t\t- Airconditioned with TV\n\t\t\t\t\t\t\t\t- Pool and Mini Bar");
        break;
    default:
...
System.out.println("You have chosen... \nDeluxe Room" + roomType + ": Price: Php " + price);
...
String deluxeProceed = input.nextLine().trim().toLowerCase();
System.out.print("=================================================================================================================================================================");
System.out.print("\n\n");

switch (deluxeProceed) {
    case "a":
...
System.out.println("\n================================================================= Reservation Summary ================================================================");
System.out.println("\t\t\t\t\t\t\t\tRoom Type: Deluxe Room " + roomType);
